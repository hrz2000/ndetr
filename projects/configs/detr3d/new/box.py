...
wp_refine=None # gru, linear, None # 先尝试bug是否在这，先用gt取代pred展示
wp_refine_input_last=False

gru_use_box=3 # 可能bug在这？但是之前没有观察到
velo_update=False
        ...
        transformer=dict(
            ...
            decoder=dict(
                ...
                transformerlayers=dict(
                    type='DetrTransformerDecoderLayer_my',
                    attn_cfgs=[
                        dict(
                            type='MultiheadAttention_my',
                            embed_dims=256,# TODO
                            num_heads=8,
                            dropout=0.1),
                        dict(
