...
# print(RoadOption.LANEFOLLOW) # 4
# print(RoadOption.CHANGELANELEFT) # 5
# print(RoadOption.CHANGELANERIGHT) # 6
# print(RoadOption.STRAIGHT) # 3
# print(RoadOption.LEFT) # 1
# print(RoadOption.RIGHT) # 2
# num2str = {1:"left",2:'right',3:'straight',4:'lanefollow',5:'changelaneleft',6:'changelaneright'}
