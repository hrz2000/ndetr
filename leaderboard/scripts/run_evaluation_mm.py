...
def parse_args():
    ...
    parser.add_argument('port', help='train config file path')
    parser.add_argument('trafficManagerPort', help='train config file path')
...
def main():
    ...
    cfg.port = args.port
    cfg.trafficManagerPort = args.trafficManagerPort
    print("start...")
